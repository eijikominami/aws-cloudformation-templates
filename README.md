...
| --- | --- | --- |
| Amazon CloudWatch Synthetics | [Runtime](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Library_nodejs_puppeteer.html) | syn-nodejs-puppeteer-6.2 |
