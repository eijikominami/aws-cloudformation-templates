...
| --- | --- | --- | --- | --- |
| ActiveDirectoryAccountNameForAppStream | String | appstream | | The user name of the account | 
...
| AppStreamImageName | String | AppStream-WinServer2019-01-26-2024 | | The name of the image used to create the fleet |
...
| SubnetPrivateCidrBlockForAz1 | String | 10.2.8.0/24 | ○ | The private subnet CIDR block at AZ1 |
| SubnetPrivateCidrBlockForAz2 | String | 10.2.10.0/24 | ○ | The private subnet CIDR block at AZ2 |
| SubnetPrivateCidrBlockForAz3 | String | 10.2.12.0/24 | ○ | The private subnet CIDR block at AZ3 |
| SubnetPublicCidrBlockForAz1 | String | 10.2.9.0/25 | ○ | The public subnet CIDR block at AZ1 |
| SubnetPublicCidrBlockForAz2 | String | 10.2.11.0/25 | ○ | The public subnet CIDR block at AZ2 |
| SubnetPublicCidrBlockForAz3 | String | 10.2.13.0/25 | ○ | The public subnet CIDR block at AZ3 |
| SubnetTransitCidrBlockAz1 | String | 10.2.9.128/25 | ○ | The transit subnet CIDR block at AZ1 |
| SubnetTransitCidrBlockAz2 | String | 10.2.11.128/25 | ○ | The transit subnet CIDR block at AZ2 |
| SubnetTransitCidrBlockAz3 | String | 10.2.13.128/25 | ○ | The transit subnet CIDR block at AZ3 |
...
| WorkspacesBundleId | String | wsb-7jspy3qyc | | The identifier of the bundle for the WorkSpace |
...
| WorkspacesUserNames | CommaDelimitedList | unknown | | ○ | The user name of the user for the WorkSpace |
