...
14. Click ``Connect to your Elasticsearch index``, choose ``Create index pattern``.
15. Choose **Index Pattern** and enter ``realtime*``.

![](../images/kibana_setting_7.png)

16. Click **Next step**.
17. Choose **Time Filter field name** and enter ``timestamp``.

![](../images/kibana_setting_8.png)

18. Then you can see the ``realtime*`` index.

![](../images/kibana_setting_9.png)

19. Import [visualizes and a dashboard](export.ndjson) to your Kibana.